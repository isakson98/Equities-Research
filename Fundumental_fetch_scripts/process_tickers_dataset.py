...
def match_changes_w_current():
    ...
    current_df[["Ticker", "Name"]].to_csv(final_path + "current.csv", index=False)
    return
...
'''
This function is just to check whether 0 for float was the result
of getting too many requests, or because they legitimately didn't have these
'''
